...
var dealercontext_1 = require("./dealercontext");
var appRoutes = [
    ...
    { path: 'leadview', component: leadview_1.LeadView },
    { path: 'leads', component: leadinfo_1.Leads },
    { path: 'lead-info', component: leaddetails_1.LeadInformation },
    { path: 'login', component: dealercontext_1.DealerContext },
...
AppModule = __decorate([
    core_1.NgModule({
        ...
        providers: [dealerService_1.dealerservice, models_1.dealerLeads, models_1.feature, models_1.shareService, models_1.MessageService],
