 ...
 */
@Entity
@Table(name = "vehicleareaofoperstate")
public class VehicleAreaOfOperState implements Serializable {
	...
	@Column(name = "VEHICLEDEALOPERSTATEID")
