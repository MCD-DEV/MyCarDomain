 ...
 */
@Entity
@Table(name = "tempcarmodelcountry")
public class TempCarModelCountry implements Serializable {
	...
	@Column(name = "TEMPCARMODELCOUNTRYID")
	public Long getTempCarModelCountryId() {
