 ...
 */
@Entity
@Table(name = "tempcarmodelintfitting")
public class TempCarModelIntFitting implements Serializable {
	...
	@Column(name = "INTFITTINGDESCRIPTION")
	...
	@Column(name = "TEMPCARMODELINTFITTINGID")
