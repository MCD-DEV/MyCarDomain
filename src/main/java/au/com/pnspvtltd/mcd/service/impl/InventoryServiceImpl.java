...
public class InventoryServiceImpl implements InventoryService {
	...
	@Override
	public List<InventoryVO> getMinifiedInventoryFor(String modelYear, String modelDisplay, String modelName,
			String modelTrim) {
	...
	@Override
	public List<InventoryVO> getPriceAndVendorStockInventoryFor(String modelYear, String modelDisplay,
			String modelName) {
	...
	public InventoryStatisticsVO getStatisticsFor(String modelYear, String modelDisplay, String modelName,
		...
		List<InventoryVO> inventoryVOsSortedByPrice = getPriceAndVendorStockInventoryFor(modelYear, modelDisplay,
				modelName);
		// retrieve from tempcarModelHeader
		TempCarModelHeaderVO tempCarHeaderVO = tempCarModelTemplateServiceImpl
				.getCarModelTemplateForAutoTrim(autoscoopTrim);
		...
		if (inventoryVOsSortedByPrice.size() > 0) {
			...
			inventoryStatisticsVO
					.setPriceMax(inventoryVOsSortedByPrice.get(inventoryVOsSortedByPrice.size() - 1).getPrice());
