...
public class CountyRegPostSubController {
	...
	public boolean existsPostcodeForRegion(@RequestParam("region") String region,
	...
	public List<String> getAllRegionsForCountynState(@RequestParam("country") String country,
	...
	public List<String> getRegionForCountryStates(@RequestParam("country") String country,
	...
	public List<Integer> getPostcodesForCountryStatesRegions(@RequestParam("country") String country,
			@RequestParam("states") List<String> states, @RequestParam("regions") List<String> regions) {
	...
	public List<Integer> getPostCodeForCSR(@RequestParam("country") String country, @RequestParam("state") String state,
