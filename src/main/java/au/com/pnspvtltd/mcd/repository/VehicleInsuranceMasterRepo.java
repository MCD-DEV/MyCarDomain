...
public interface VehicleInsuranceMasterRepo extends JpaRepository<VehicleDealerInsuranceDetails, Long> {
	...
	public List<VehicleDealerInsuranceDetails> findByDealer(Dealer dealer);
}
