...
public interface VehicleServMasterRepo extends JpaRepository<VehicleDealerServMaintDetails, Long> {
	...
	public List<VehicleDealerServMaintDetails> findByDealer(Dealer dealer);
}
